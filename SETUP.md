...
- **✓ OG wallet** — sent at least one mainnet transaction before November 2021, so its first 2 Plummers are free, then 0.002 ETH each
- **0.002 ETH each** — it didn't, so every Plummer it mints costs 0.002 ETH
